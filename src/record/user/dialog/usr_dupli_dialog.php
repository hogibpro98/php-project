...
<div class="dynamic_modal new_default sched_default displayed_part cancel_act" style="height:600px;width:950px!important;overflow: scroll!important;overflow-y: auto;overscroll-behavior-y: contain;top:60%;">
    ...
    <div class="sched_tit">利用者スケジュール予定複製</div>
            ...
            <ol id="dtl_root">
                <?php if (empty($serviceData)) : ?>
                    <li>
                        ...
                        <small>～</small>
                        <select class="validate[required]" id="end_time_h_<?= $detail_i ?>" name="<?= $svcPrefix ?><?= $svcPrefix ?>[0][end_time_h]" style="width:60px;">
                            <?php foreach ($selHour as $val) : ?>
                                <option value="<?= $val ?>"><?= $val ?></option>
                            <?php endforeach; ?>
                        </select>
    ...
    <div class="s_constrols">
        ...
        <p>
            ...
            <button type="submit" name="btnNewUserPlan" value="true" class="btn save" style="width:60px;height:37px;font-size: 15px;">保存</button>
        </p>
    </div>
    <!-- 下部ボタンエリア:end-->
    <div class="update">
