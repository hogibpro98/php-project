...
$tgtData      = initTable('dat_staff_record');
...
<div class="dynamic_modal sched_details add_memo_details rt_memo cancel_act" style="left:50%;width:450px;display:block;">
    ...
    <div class="sched_tit">従業員スケジュール編集(実績)</div>
    <div class="s_detail">
        <div class="box1">
            <p class="mid">日付/時刻</p>
    ...
    <div class="s_constrols">
        ...
        <p>
            <button type="submit" class="btn save" name="btnEditStfRcd" value="<?= $dispData['unique_id'] ?>">保存</button>
        </p>
    </div>
    <div class="update">
        最終更新:
