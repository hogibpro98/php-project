                            ...
                            <form action="" class="p-form-validate" method="">
                                <div class="log-details" style="margin-top:20px;">
                                    <div class="box" style="width:1000px;">
                                        <div class="filter_box" style="display:flex; justify-content:space-between; width:900px;">
                                            <div class="fil_con">
                                            ...
                                            <div class="fil_con">
                                                ...
                                                <span><input type="checkbox" name="search[importantly]" value="重要" id="importantly" <?= $search['importantly'] === "重要" ? 'checked' : '' ?>><label for="importantly">重要</label></span>
                                            </div>
                                        </div>
                                        <div class="filter_box" style="display:flex; justify-content:space-between; width:550px;">
                                            <div class="fil_con">
                                                <span class="label_t text_blue">内容区分①</span>
                                                <select id="fil_con" name="search[type1]" style="width:auto;">
                                                    <option value=""></option>
                                                    <?php foreach ($progressReportMst['内容区分①'] as $key => $val): ?>
                                                        <?php $select = $search['type1'] == $val ? ' selected' : NULL; ?>
                                            ...
                                            <div class="fil_cat pc">
                                                <span class="label_t text_blue">内容区分②</span>
                                                <select id="fil_cat" name="search[type2]" style="width:auto;">
                                                    <option value=""></option>
                                                    <?php foreach ($progressReportMst['内容区分②'] as $key => $val): ?>
                                                        <?php $select = $search['type2'] == $val ? ' selected' : NULL; ?>
                                                        <option value="<?= $val ?>"<?= $select ?>><?= $val ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                    ...
                                    <div class="s_control">
                                        <span class="btn add"  style="padding:2px;"><a href="/report/progress/index.php">新規作成</a></span>
                                    </div>
                                </div>
                            </form>
                            <div class="wrap">
