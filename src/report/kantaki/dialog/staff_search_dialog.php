...
?>
<div class="staff_modal new_default sched_default displayed_part cancel_act" style="height:600px;width:950px!important;overflow: scroll!important;overflow-y: auto;overscroll-behavior-y: contain;top:60%;">
    ...
    <script>
        $(function() {
            // モーダルから選択
            $(".staff_modal").find("table button").on("click", function() {
                // 各種データ取得
