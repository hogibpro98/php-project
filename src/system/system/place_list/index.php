...
<div class="wrap">
	...
	<table class="dis_result">
		...
		<tr>
			...
			<td><a href="/system/office/?place_id=<?= $tgtId ?>"><?= $val['看多機']['name'] ?></a></td>
                        <?php else: ?>
			<td></td>
                        <?php endif; ?>
                        <?php if (isset($val['訪問看護'])): ?>
			<td><a href="/system/office/?place_id=<?= $tgtId ?>"><?= $val['訪問看護']['name'] ?></a></td>
                        <?php else: ?>
			<td></td>
                        <?php endif; ?>
			<td><div class="btn edit"><a href="/system/place_edit?place_id=<?= $tgtId ?>">編集</a></div></td>
		</tr>
                <?php endforeach; ?>
<!--		<tr>
			<td>長野看多機拠点かえりえ</td>
