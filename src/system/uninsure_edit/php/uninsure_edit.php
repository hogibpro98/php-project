...
foreach($tgtOfficeList as $idx => $val){
    $ofcName = $val['name'];
    $officeList[$ofcName] = $val;
}
...
if ($btnEntry && $upAry){
    ...
    $ofcName = $upAry['office'];
    $ofcId = isset($officeList[$ofcName]['unique_id']) ? $officeList[$ofcName]['unique_id'] : NULL;
    $upAry['link_office'] = $ofcId;
