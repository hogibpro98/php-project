                        ...
                        <div id="subpage"><div id="user-new" class="nursing user_info">
                                ...
                                <div class="wrap">
                                    ...
                                    <ul class="user-tab">
                                        ...
                                        <li><a href="/report/list/?user=<?= $userId ?>">各種帳票</a></li>
                                            ...
                                            <div class="basic_info con_box">
                                                <div class="box-l">
                                                    <div class="tab">
                                                        <table>
                                                            <tr class="tr1">
                                                                <th><span class="label_t label_y">利用者ID</span></th>
                                                                <td>
                                                                        ...
                                                                        <div class="hist_list" >
                                                                            ...
                                                                            <ul class="office_history">
                                                                                <?php foreach ($dispData['office1'] as $key => $val): ?>
                                                                                    ...
                                                                                    ?>
                                                                                    <li style="display:flex;" class="history_<?= !empty($val['unique_id']) ? $val['unique_id'] : $i ?>">
                                                                                        <span style="width:120px">
                                                                                            <?php if(!empty($val['unique_id'])) : ?>
                                                                                                <input type="hidden" name="upOfc1[<?= $val['unique_id'] ?>][unique_id]" value="<?= !empty($val['unique_id']) ? $val['unique_id'] : '' ?>">
                                                                                            <?php endif; ?>
                                                                                            <input type="hidden" name="upOfc1[<?= !empty($val['unique_id']) ? $val['unique_id'] : $i ?>][start_day]" value="<?= $val['start_day'] ?>" >
                                                                                            <input type="hidden" name="upOfc1[<?= !empty($val['unique_id']) ? $val['unique_id'] : $i ?>][end_day]" value="<?= $val['end_day'] === "0000-00-00" ? '' : $val['end_day'] ?>" >
                                                                                            <input type="hidden" name="upOfc1[<?= !empty($val['unique_id']) ? $val['unique_id'] : $i ?>][office_id]" value="<?= $val['office_id'] ?>" >
                                                                                            <input type="hidden" name="upOfc1[<?= !empty($val['unique_id']) ? $val['unique_id'] : $i ?>][office_name]" value="<?= $val['office_name'] ?>" >
                                                                                            <?= $val['start_day'] ?><br/>〜<?= $val['end_day'] === "0000-00-00" ? '' : $val['end_day'] ?>
                                                                                        </span>
                                                                                        <div style="width:200px"><?= $val['office_name'] ?></div>
                                                                                        <button type="button" class="btn-edit office office_edit modal_open"
                                                                                                name="" value="<?= !empty($val['unique_id']) ? $val['unique_id'] : '' ?>"
                                                                                                data-url="/user/edit/dialog/office3.php?user_office_id=<?= !empty($val['unique_id']) ? $val['unique_id'] : '' ?>&office_name=<?= $val['office_name'] ?>&office_id=<?= $val['office_id'] ?>&start_day=<?= $val['start_day'] ?>&end_day=<?= $val['end_day'] === "0000-00-00" ? '' : $val['end_day'] ?>&tgt_id=history_<?= !empty($val['unique_id']) ? $val['unique_id'] : $i ?>&mode=edit"
                                                                                                data-id="<?= !empty($val['unique_id']) ? $val['unique_id'] : '' ?>"
                                                                                                data-user_office_id="<?= !empty($val['unique_id']) ? $val['unique_id'] : ''  ?>"
                                                                                                data-office_id="<?= $val['office_id'] ?>"
                                                                                                data-office_no="<?= !empty($val['office_no']) ? $val['office_no'] : '' ?>"
                                                                                                data-start_day="<?= $val['start_day'] ?>"
                                                                                                data-end_day="<?= $val['end_day'] === "0000-00-00" ? '' : $val['end_day'] ?>"
                                                                                                data-office_name="<?= $val['office_name'] ?>"
                                                                                                data-dialog_name="dynamic_modal">編集</button>
                                                                                        <button type="submit" class="btn-del row_delete2" name="btnDelOffice" value="<?= !empty($val['unique_id']) ? $val['unique_id'] : true  ?>" style="margin-left:10px;">削除</button>
                                                                                    </li>
                                                                                <?php endforeach; ?>
                                                                            </ul>
                                                                        </div>
                                        ...
                                        <?php if ($tab == 2): ?>
                                            <div class="payment_mode con_box">
                                                ...
                                                <div class="">
                                                    <div class="opt_list1">
                                                        <dl>
                                                            <dt><span class="label_t">金融機関コード</span><span class="req">*</span><span class="text_blue">4桁の数字</span></dt>
                                                        ...
                                                        <dl>
                                                            <dt><span class="label_t">金融機関名</span><span class="req">*</span><span class="text_blue">最大全角10文字</span></dt>
                                                    ...
                                                    <div class="opt_list2">
                                                        <dl>
                                                            <dt><span class="label_t">支店コード</span><span class="req">*</span><span class="text_blue">5桁の数字</span></dt>
                                                        ...
                                                        <dl>
                                                            <dt><span class="label_t">支店名</span><span class="req">*</span><span class="text_blue">最大全角10文字</span></dt>
                                                        ...
                                                        <dl>
                                                            <dt><span class="label_t">口座番号</span><span class="req">*</span><span class="text_blue">7桁の数字</span></dt>
                                                        ...
                                                        <dl>
                                                            <dt><span class="label_t">預金者名</span><span class="req">*</span><span class="text_blue">半角カナのみ/<br class="sm"/>最大20文字</span></dt>
                                                    ...
                                                    <div class="opt_list3">
                                                        <dl>
                                                            <dt><span class="label_t">預金種別</span><span class="req">*</span></dt>
                                                            <dd>
                                                                        ...
                                                                        <dl class="exp_l1">
                                                                            ...
                                                                            <dd>
                                                                                ...
                                                                                <div>
                                                                                    ...
                                                                                    <span><input type="text" name="" value="<?= $val['end_dt'] ?>" id="birth_d" class="b_ymd bg-gray2 ins4_ed" readonly=""><label for="birth_d">日</label></span>
                                                                                </div>
                                                                            </dd>
