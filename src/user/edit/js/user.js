$(document).ready(function () {
    ...
    // プルダウンのoption内容をコピー
    var pd2 = $("#municipal option").clone();

    // 1→2連動
    $("#prefecture").change(function () {

        // lv1のvalue取得
        var lv1Val = $("#prefecture").val();
        ...
        // 「▼選択」optionを先頭に表示
        $("#municipal").prepend('<option value="" selected="selected">▼選択</option>');
    });

    /* -- 緊急連絡先2用 --------------------------*/

    // プルダウンのoption内容をコピー
    var pd22 = $("#municipal2 option").clone();

    // 1→2連動
    $("#prefecture2").change(function () {
        // lv1のvalue取得
        var lv1Val2 = $("#prefecture2").val();
        ...
        // 「▼選択」optionを先頭に表示
        $("#municipal2").prepend('<option value="" selected="selected">▼選択</option>');
    });

    /* -- 緊急連絡先3用 --------------------------*/

    // プルダウンのoption内容をコピー
    var pd23 = $("#municipal3 option").clone();

    // 1→2連動
    $("#prefecture3").change(function () {
        // lv1のvalue取得
        var lv1Val3 = $("#prefecture3").val();
        ...
        // 「▼選択」optionを先頭に表示
        $("#municipal3").prepend('<option value="" selected="selected">▼選択</option>');
    });

    // 支払方法の入力制御
    setPaymentItemDisabled($('input[name="upPay[method]"]:checked').val());
...
$(function () {
    ...
    // 薬情変更フラグ
    var medInfoChange = false;

    // 利用者メモ変更フラグ
    var userMemoChange = false;
    ...
    $(".ins1-edit").click(function () {
        ...
        var ins1_certif_nengo = $(this).data("ins1_certif_nengo");
        var ins1_certif_year = $(this).data("ins1_certif_year");
        var ins1_certif_month = $(this).data("ins1_certif_month");
        var ins1_certif_dt = $(this).data("ins1_certif_dt");
        ...
        $(".ins1_certif_year1").val(ins1_certif_year);
        $(".ins1_certif_month1").val(ins1_certif_month);
        $(".ins1_certif_dt1").val(ins1_certif_dt);
    ...
    $(".ofc2-edit").click(function () {
        ...
        // 各種データ取得
        var ofc2_id = $(this).data("ofc2_id");
        var ofc2_sdt = $(this).data("ofc2_start_day");
        var ofc2_edt = $(this).data("ofc2_end_day1");
        var ofc2_ono = $(this).data("ofc2_office_no");
        var ofc2_onm = $(this).data("ofc2_office_name");
        var ofc2_add = $(this).data("ofc2_address");
        var ofc2_tel = $(this).data("ofc2_tel");
        var ofc2_fax = $(this).data("ofc2_fax");
        var ofc2_fdt = $(this).data("ofc2_found_day");
        var ofc2_pnm = $(this).data("ofc2_person_name");
        var ofc2_pkn = $(this).data("ofc2_person_kana");
        var ofc2_ptp = $(this).data("ofc2_plan_type");
        var ofc2_ctp = $(this).data("ofc2_cancel_type");
        var ofc2_cmm = $(this).data("ofc2_cancel_memo");
    ...
    $(".ins3-edit").click(function () {
        ...
        // 各種データ取得
        var ins3_id = $(this).data("ins3_id");
        var ins3_stn = $(this).data("ins3_start_nengo");
        var ins3_sty = $(this).data("ins3_start_year");
        var ins3_stm = $(this).data("ins3_start_month");
        var ins3_std = $(this).data("ins3_start_dt");
        var ins3_edn = $(this).data("ins3_end_nengo");
        var ins3_edy = $(this).data("ins3_end_year");
        var ins3_edm = $(this).data("ins3_end_month");
        var ins3_edd = $(this).data("ins3_end_dt");
        var ins3_sl1 = $(this).data("ins3_select1");
        var ins3_sl2 = $(this).data("ins3_select2");
        var ins3_tp1 = $(this).data("ins3_type1");
        var ins3_tp2 = $(this).data("ins3_type2");
        var ins3_tp3 = $(this).data("ins3_type3");
        var ins3_no1 = $(this).data("ins3_number1");
        var ins3_no2 = $(this).data("ins3_number2");
        var ins3_no3 = $(this).data("ins3_number3");
        var ins3_no4 = $(this).data("ins3_number4");
        var ins3_mo5 = $(this).data("ins3_number5");
        var ins3_nam = $(this).data("ins3_name");
        var ins3_tp4 = $(this).data("ins3_type4");
    ...
    $(".ins4-edit").click(function () {
        ...
        // 各種データ取得
        var ins4_id = $(this).data("ins4_id");
        var ins4_stn = $(this).data("ins4_start_nengo");
        var ins4_sty = $(this).data("ins4_start_year");
        var ins4_stm = $(this).data("ins4_start_month");
        var ins4_std = $(this).data("ins4_start_dt");
        var ins4_edn = $(this).data("ins4_end_nengo");
        var ins4_edy = $(this).data("ins4_end_year");
        var ins4_edm = $(this).data("ins4_end_month");
        var ins4_edd = $(this).data("ins4_end_dt");
        var ins4_no1 = $(this).data("ins4_number1");
        var ins4_name = $(this).data("ins4_name");
        var ins4_no2 = $(this).data("ins4_number2");
        var ins4_no3 = $(this).data("ins4_number3");
        var ins4_no4 = $(this).data("ins4_upper_limit");
        var ins4_rat = $(this).data("ins4_rate");
    ...
    $(".hsp-edit").click(function () {
        ...
        var hsp_std = $(this).data("hsp_start_day");
        var hsp_edd = $(this).data("hsp_end_day");
        var hsp_sl1 = $(this).data("hsp_select1");
        var hsp_tp1 = $(this).data("hsp_type1");
        var hsp_nam = $(this).data("hsp_name");
        var hsp_dsp = $(this).data("hsp_disp_name");
        var hsp_doc = $(this).data("hsp_doctor");
        var hsp_add = $(this).data("hsp_address");
        var hsp_tel1 = $(this).data("hsp_tel1");
        var hsp_tel2 = $(this).data("hsp_tel2");
        var hsp_fax = $(this).data("hsp_fax");
    ...
    $(".svc-edit").click(function () {
        ...
        // 各種データ取得
        var svc_id = $(this).data("svc_id");
        var svc_std = $(this).data("svc_start_day");
        var svc_edd = $(this).data("svc_end_day");
        var svc_stp = $(this).data("svc_start_type");
        var svc_crs = $(this).data("svc_cancel_reason");
        var svc_ddt = $(this).data("svc_death_day");
        var svc_dtm = $(this).data("svc_death_time");
        var svc_dpl = $(this).data("svc_death_place");
        var svc_drs = $(this).data("svc_death_reason");
    ...
    $(".int-edit").click(function () {
        ...
        // 各種データ取得
        var int_id = $(this).data("int_id");
        var int_nam1 = $(this).data("int_in1_name");
        var int_cop1 = $(this).data("int_in1_company");
        var int_pst1 = $(this).data("int_in1_post");
        var int_add1 = $(this).data("int_in1_address");
        var int_tel1 = $(this).data("int_in1_tel");
        var int_fax1 = $(this).data("int_in1_fax");
        var int_mal1 = $(this).data("int_in1_mail");
        var int_ps11 = $(this).data("int_in1_person1");
        var int_ps12 = $(this).data("int_in1_person2");
        var int_ps13 = $(this).data("int_in1_person3");
        var int_str1 = $(this).data("int_in1_start");
        var int_rmk1 = $(this).data("int_in1_remarks");
        var int_nam2 = $(this).data("int_in2_name");
        var int_cop2 = $(this).data("int_in2_company");
        var int_pst2 = $(this).data("int_in2_post");
        var int_add2 = $(this).data("int_in2_address");
        var int_tel2 = $(this).data("int_in2_tel");
        var int_fax2 = $(this).data("int_in2_fax");
        var int_mal2 = $(this).data("int_in2_mail");
        var int_ps21 = $(this).data("int_in2_person1");
        var int_ps22 = $(this).data("int_in2_person2");
        var int_ps23 = $(this).data("int_in2_person3");
        var int_rmk2 = $(this).data("int_in2_remarks");
        var int_otdt = $(this).data("int_out_day");
        var int_otnm = $(this).data("int_out_name");
        var int_otps = $(this).data("int_out_person");
        var int_ottp = $(this).data("int_out_type");
        var int_otmm = $(this).data("int_out_memo");
...
//        var dl_box = $("#img_box dl:nth-child(1)");
        ...
        dd_new += '<label>';
        dd_new += '<span class="btn upload"><img src="/common/image/icon_upload.png" alt=""></span>';
        dd_new += '<input type="file" name="" id="<?= $key ?>" style="display:none;">';
        dd_new += '</label>';
        dd_new += '</dd>';
//        var num = i++;
...
//    });
    ...
    $(".ins_add3").click(function () {
        ...
        tr_new += '    <td>';
        tr_new += '        <div>';
        tr_new += '            <select class="era validate[required]" name="upDummy[ins2][' + row + '][start_nengo]">';
        ...
        tr_new += '            </select>';
        tr_new += '            <span>';
        tr_new += '                <input type="text" name="upDummy[ins2][' + row + '][start_year]" value="" id="birth_yr" class="b_ymd validate[required,maxSize[3]]"><label for="birth_yr">年</label>';
        tr_new += '            </span>';
        tr_new += '            <span>';
        tr_new += '                <input type="text" name="upDummy[ins2][' + row + '][start_month]" value="" id="birth_m" class="b_ymd validate[required,maxSize[2]]"><label for="birth_m">月</label>';
        tr_new += '            </span>';
        tr_new += '            <span>';
        tr_new += '                <input type="text" name="upDummy[ins2][' + row + '][start_dt]" value="" id="birth_d" class="b_ymd validate[required,maxSize[2]]"><label for="birth_d">日</label>';
        tr_new += '            </span>';
        tr_new += '        </div>';
        tr_new += '    </td>';
        tr_new += '    <td>';
        ...
        tr_new += '    <td>';
        tr_new += '        <div>';
        tr_new += '            <select class="era" name="upDummy[ins2][' + row + '][end_nengo]">';
        tr_new += '                <option value=""></option>';
        tr_new += '                <option value="昭和">昭和</option>';
        tr_new += '                <option value="平成">平成</option>';
        tr_new += '                <option value="令和" selected>令和</option>';
        tr_new += '            </select>';
        tr_new += '            <span>';
        tr_new += '                <input type="text" name="upDummy[ins2][' + row + '][end_year]" value="" id="birth_yr" class="b_ymd validate[required,maxSize[3]]"><label for="birth_yr">年</label>';
        tr_new += '            </span>';
        tr_new += '            <span>';
        tr_new += '                <input type="text" name="upDummy[ins2][' + row + '][end_month]" value="" id="birth_m" class="b_ymd validate[required,maxSize[2]]"><label for="birth_m">月</label>';
        tr_new += '            </span>';
        tr_new += '            <span>';
        tr_new += '                <input type="text" name="upDummy[ins2][' + row + '][end_dt]" value="" id="birth_d" class="b_ymd validate[required,maxSize[2]]"><label for="birth_d">日</label>';
        tr_new += '            </span>';
        tr_new += '        </div>';
        tr_new += '    </td>';
        tr_new += '    <td>';
        tr_new += '        <span>';
        tr_new += '            <input type="text" name="upIns2[' + row + '][rate]" id="rate1" value="" class="validate[required,maxSize[3]]" style="width:50px;">';
        tr_new += '        </span>';
        tr_new += '    </td>';
        tr_new += '    <td>';
        tr_new += '        <span class="btn trash ins2_new_del" style="width:60px;">削除</span>';
        tr_new += '    </td>';
        tr_new += '</tr>';
...
//    });
    ...
    $(".med_add2").click(function () {
        var tbl = $(".med_table2");
        var row = drug.rows.length+1;
        var tr_new = "";
        tr_new += '<tr>';
        tr_new += '    <td>';
        tr_new += '        <input type="text" name="upDrg[' + row + '][start_day]" class="master_date date_no-Day" value="">';
        tr_new += '    </td>';
        tr_new += '    <td>';
        tr_new += '    </td>';
        tr_new += '    <td>';
        tr_new += '       <input type="text" name="upDrg[' + row + '][end_day]" class="master_date date_no-Day" value="">';
        tr_new += '    </td>';
        tr_new += '    <td>';
        tr_new += '        <input type="text" name="upDrg[' + row + '][drug_name]" class="iyakuhin_n" value="">';
        tr_new += '    </td>';
        tr_new += '    <td>';
        ...
        tr_new += '    </td>';
        tr_new += '    <td>';
        tr_new += '        <input type="text" name="upDrg[' + row + '][dose]" class="amount" value="">';
        tr_new += '    </td>';
        tr_new += '    <td>';
        tr_new += '        <input type="text" name="upDrg[' + row + '][effect]" class="effect" value="">';
        tr_new += '    </td>';
        tr_new += '    <td>';
        tr_new += '        <input type="text" name="upDrg[' + row + '][side_effect]" class="side_effect" value="">';
        tr_new += '    </td>';
        tr_new += '    <td>';
        tr_new += '        <input type="text" name="upDrg[' + row + '][remarks]" class="remark">';
        tr_new += '    </td>';
        tr_new += '    <td>';
...
//    });
    ...
    $(".fml_add").click(function () {
        var tbl = $(".kazoku_kosei");
        var row = family.rows.length;
        var tr_new = "";
        tr_new += '<tr>';
        tr_new += '    <td style="width:70px;">';
        tr_new += '    </td>';
        tr_new += '    <td style="width:200px;">';
        tr_new += '    <select name="upFml[' + row + '][type]" class="em_con-list2" data-key="' + row + '" onchange="copyFamily(this)">';
        tr_new += '        <option value=""></option>';
        tr_new += '        <option value="1">緊急連絡先①を反映</option>';
        tr_new += '        <option value="2">緊急連絡先②を反映</option>';
        tr_new += '        <option value="3">緊急連絡先③を反映</option>';
        tr_new += '    </select>';
        tr_new += '        <input type="hidden" name="btnFmlCopy" class="copyFml" value="">';
        tr_new += '    </td>';
        tr_new += '    <td style="width:150px;">';
        tr_new += '        <input type="text" name="upFml[' + row + '][name]" class="name fml-name-' + row + '" maxlength="30" value="">';
        tr_new += '    </td>';
        tr_new += '    <td style="width:80px;">';
        tr_new += '        <input type="text" name="upFml[' + row + '][relation_type]" class="relation fml-relation_type-' + row + '" maxlength="10" value="">';
        tr_new += '    </td>';
        tr_new += '    <td style="width:150px;">';
        tr_new += '        <input type="text" name="upFml[' + row + '][relation_memo]" class="relation_memo fml-relation_memo-' + row + '" maxlength="256" value="">';
        tr_new += '    </td>';
        tr_new += '    <td style="width:150px;">';
        tr_new += '        <input type="text" name="upFml[' + row + '][business]" class="occupation fml-business-' + row + '" maxlength="30" value="">';
        tr_new += '    </td>';
        tr_new += '    <td style="width:350px;">';
        tr_new += '        <input type="text" name="upFml[' + row + '][remarks]" class="remark fml-remarks-' + row + '" value="">';
        tr_new += '    </td>';
        tr_new += '    <td style="width:80px;">';
        tr_new += '        <button type="button" id="btn_del_fml2" class="btn-del" name="btnDelFml2" style="width:70px;" value="削除">削除</button>';
        tr_new += '    </td>';
        tr_new += '</tr>';
        $(tr_new).prependTo(tbl);
    });
...
//    });
    ...
    window.onbeforeunload = function (event) {
        if (medInfoChange) {
            event.preventDefault();
            event.returnValue = "薬情が保存されていません。ページを離れてよろしいですか？";
...
//    
//        var medInstitution = $('#med_institution-n').val();
//        $('#receipt_name').val(medInstitution);
//
//        var count = medInstitution.length;
//        if (count >= 16) {
...
//    });
    ...
    $('.office3').on('click', function () {
        ...
        var tgUrl = "/user/edit/dialog/office3.php?user_id=" + userId;
...
//        $(this).next().slideToggle();
    ...
    $('input[name="upPay[method]"]').on("click", function () {
        setPaymentItemDisabled($(this).val());
    });
...
// 認定有効期間をコピー
function periodCopy() {
    var start_nengo = $(".tgt_sn1").val();
    var start_year = $(".tgt_sy1").val();
    var start_month = $(".tgt_sm1").val();
    var start_day = $(".tgt_sd1").val();
    var end_nengo = $(".tgt_en1").val();
    var end_year = $(".tgt_ey1").val();
    var end_month = $(".tgt_em1").val();
    var end_day = $(".tgt_ed1").val();
...
// １ヶ月有効にする(1か月後)
function addMonth() {
    var start_nengo = $(".ins4_sn").val();
    var start_year = $(".ins4_sy").val();
    var start_month = $(".ins4_sm").val();
    var start_day = $(".ins4_sd").val();
    var tgt_year = seireki(start_nengo + start_year + '年');

    var dt = new Date(tgt_year + '/' + start_month + '/' + start_day);
...
// １ヶ月有効にする(月末設定)
function addMonth2() {
    var start_nengo = $(".ins4_start_nengo").val();
    var start_year = $(".ins4_start_year").val();
    var start_month = $(".ins4_start_month").val();
    var start_day = $(".ins4_start_dt").val();
    var tgt_year = seireki(start_nengo + start_year + '年');
...
function copyFamily(obj) {
    ...
    var slct = obj.options[idx].value;

    // data-key
    var seq = $(obj).data("key");

    // コピー元の情報を取得
    var name = $(".emg-name-" + slct).val();
    var type = $(".emg-relation_type-" + slct).val();
    var memo = $(".emg-relation_memo-" + slct).val();
    var rmks = $(".emg-remarks-" + slct).val();
...
function checkDupList() {
    var lname = $('.standard_last_kana').val();
    var fname = $('.standard_first_kana').val();
    var erayr = $('.standard_wareki').val();
    var birth_yr = $('.standard_year').val();
    var birth_m = $('.standard_month').val();
    var birth_d = $('.standard_day').val();
    ...
    // 生年月日（西暦）
    var birthday = birth_yr + '-' + birth_m + '-' + birth_d;
    // モーダルダイアログ呼び出し
    var userId = getUrlParam('id');
    var dlgName = "dynamic_modal";
    var tgUrl = "/user/edit/dialog/duplication.php?user_id=" + userId + '&birthday=' + birthday + '&first_kana=' + fname + '&last_kana=' + lname;
    console.log(tgUrl);
...
function setPaymentItemDisabled(value) {

    let isDisabled = (value != '引き落とし');
    $('.financial_cat').find('select').prop('disabled', isDisabled);
    $('.opt_list1').find('input').prop('disabled', isDisabled);
    $('.opt_list1').find('a').css('pointer-events', (isDisabled  ? 'none' : ''));
    $('.opt_list2').find('input').prop('disabled', isDisabled);
    $('.opt_list3').find('select').prop('disabled', isDisabled);

    if (isDisabled) {
        $('.payment_mode').find('.label_t').removeClass('label_y');
        $('.opt_list1').find('input').val('');
        $('.opt_list2').find('input').val('');
        $('.financial_cat').find('select').val('');
        $('.opt_list3').find('select').val('');
    } else {
        $('.payment_mode').find('.label_t').addClass('label_y');
    }
}

// レセプト出力名称 入力可否制御
function changeHsp(value) {
    var count = value.length;
    
     // 16文字以上の場合は、レセプト出力名称を編集可にする。
    if (count >= 16) {
        $('#receipt_name2').removeAttr('readOnly');
        $('#receipt_name2').removeClass('bg-gray2');
    }
}