...
$(function () {
  ...
  $('.ins3-edit').click(function () {
    ...
    const ins3_stn = !$(this).data("ins3_start_nengo") ? '令和' : $(this).data("ins3_start_nengo");
    const ins3_sty = $(this).data("ins3_start_year");
    const ins3_stm = $(this).data("ins3_start_month");
    const ins3_std = $(this).data("ins3_start_dt");
    const ins3_edn = !$(this).data("ins3_end_nengo") ? '令和' : $(this).data("ins3_end_nengo");
  ...
  $('.ins_add3').click(function () {
    ...
    tr_new += '    <td>';
    tr_new += '        <div>';
    tr_new += '            <select class="validate[required]" name="upIns2[' + row + '][rate]" style="width:60px;">';
    tr_new += '                <option value=""></option>';
    tr_new += '                <option value="90">90</option>';
    tr_new += '                <option value="80">80</option>';
    tr_new += '                <option value="70">70</option>';
    tr_new += '            </select>';
    tr_new += '        </div>';
    tr_new += '    </td>';
    tr_new += '    <td>';
