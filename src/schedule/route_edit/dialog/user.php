...
<div class="cont_user cancel_act">
    ...
    <div>
        <span class="label_t" style="font-weight: 500; margin-right: 10px;">氏名漢字／カナ</span>
        ...
        $(".tgt-usr_id").on("input",function(){
            ...
            $(".cont_user button").each(function(){
                ...
                if(usr_id == inputText){
                    ...
                    $(".tgt-usr_adr").val(usr_address);
                    $(".tgt-usr_rank").val(usr_rank);
                    window.location.href = '/schedule/route_edit/index.php?user=' + unique_id;
