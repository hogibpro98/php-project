...
<div class="modal new_default sched_default displayed_part cancel_act" style="height:600px;width:950px!important;">
    ...
    <div class="s_detail">
        ...
        <div class="box1">
            ...
            <p class="month_list" name="<?= $mainPrefix ?>[week_num]" required>
                <span><input type="checkbox" name="<?= $mainPrefix ?>[week_num][]" value="第1週" id="week1" <?= mb_strpos($mainData['week_num'], '第1週') !== false ? 'checked' : '' ?>><label>第1週</label></span>
                <span><input type="checkbox" name="<?= $mainPrefix ?>[week_num][]" value="第2週" id="week2" <?= mb_strpos($mainData['week_num'], '第2週') !== false ? 'checked' : '' ?>><label>第2週</label></span>
                <span><input type="checkbox" name="<?= $mainPrefix ?>[week_num][]" value="第3週" id="week3" <?= mb_strpos($mainData['week_num'], '第3週') !== false ? 'checked' : '' ?>><label>第3週</label></span>
                <span><input type="checkbox" name="<?= $mainPrefix ?>[week_num][]" value="第4週" id="week4" <?= mb_strpos($mainData['week_num'], '第4週') !== false ? 'checked' : '' ?>><label>第4週</label></span>
                <span><input type="checkbox" name="<?= $mainPrefix ?>[week_num][]" value="第5週" id="week5" <?= mb_strpos($mainData['week_num'], '第5週') !== false ? 'checked' : '' ?>><label>第5週</label></span>
                <span><input type="checkbox" name="<?= $mainPrefix ?>[week_num][]" value="第6週" id="week6" <?= mb_strpos($mainData['week_num'], '第6週') !== false ? 'checked' : '' ?>><label>第6週</label></span>
            </p>
        </div>
        <div class="box1">
            <p class="mid">利用者</p>
    ...
    <div class="s_constrols">
        ...
        <p>
            ...
            <button type="button" name="btnDupli" value="true" class="modal_open btn duplicate" style="width:60px;height:37px;font-size: 15px;" data-url="/schedule/route_edit/dialog/dupli_dialog.php?user=<?= $userId ?>&place=<?= $placeId ?>&id=<?= $schId ?>" data-dialog_name="modal" <?= $disabled ?>>複製</button>
