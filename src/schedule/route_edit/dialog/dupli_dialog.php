...
<?php endforeach; ?>
                ...
                newRow += '    <select id="jippiFieldName' + jippi_i + '" data-index="' + jippi_i + '" class="cngOffice uis_name cngJippi" name="<?= $jpiPrefix ?>[uninsure_id][]">';
                newRow += '        <option value="">選択してください</option>';
<?php foreach ($uisList as $type => $uisList2) : ?>
    <?php foreach ($uisList2 as $uisId => $uisData) : ?>
...
<?php endforeach; ?>
                ...
                newRow += '    <input id="jippiPrice' + jippi_i + '" type="text" class="validate[maxSize[7],onlyNumberSp] uis_price" name="<?= $jpiPrefix ?>[price][]" value="<?= isset($jippiList['price']) ? $jippiList['price'] : '' ?>" style="width:85px">';
                newRow += '    </td>';
                newRow += '    <td class="tax">';
...
<?php endforeach; ?>
                ...
                newRow += '      <input id="jippiUisRate' + jippi_i + '" type="text" class="validate[maxSize[7],onlyNumberSp] uis_rate" name="<?= $jpiPrefix ?>[rate][]" value="<?= isset($jippiList['rate']) ? $jippiList['rate'] : '' ?>" style="width:60px;" placeholder="半角数字2桁"><span>%</span>';
                newRow += '    </td>';
