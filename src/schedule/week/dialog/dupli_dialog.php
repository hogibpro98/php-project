...
$svcMstType = array();
if (isset($services[$userSvType])) {
    $svcMstType = $services[$userSvType];
}
$where = array();
$where['delete_flg'] = 0;
...
if(!empty($unInsType)) {
    ...
    foreach($zeiType as $cd => $val) {
        $type = $val;
        $unInsType['zei_type'][$type] = true;
    }

    // 控除対象を積む
    $subsidy = $codeList['保険外マスタ']['控除対象'];
    foreach($subsidy as $cd => $val) {
        $type = $val;
        $unInsType['subsidy'][$type] = true;
    }
}
/* -- 更新用配列作成 ---------------------------------------- */
...
<div class="modal new_default duplicated1 root_commute cancel_act" style="height:600px;width:950px!important;">
    <style>
        .list_delete2 {
            width: 32px;
            height: 32px;
    ...
    <div class="s_detail">
        ...
        <?php $jippi_i = 1; ?>
        <div class="box1">
            <p class="mid day">曜日</p>
            <p class="day_list">
                <span><input type="checkbox" name="曜日" id="dWeekAll" checked><label for="dWeekAll">一括</label></span>
                <span><input type="checkbox" name="<?= $mainPrefix ?>[day_week][]" id="dWeek1" class="dwList" value="1" checked><label for="dWeek1">月</label></span>
                <span><input type="checkbox" name="<?= $mainPrefix ?>[day_week][]" id="dWeek2" class="dwList" value="2" checked><label for="dWeek2">火</label></span>
                <span><input type="checkbox" name="<?= $mainPrefix ?>[day_week][]" id="dWeek3" class="dwList" value="3" checked><label for="dWeek3">水</label></span>
                <span><input type="checkbox" name="<?= $mainPrefix ?>[day_week][]" id="dWeek4" class="dwList" value="4" checked><label for="dWeek4">木</label></span>
                <span><input type="checkbox" name="<?= $mainPrefix ?>[day_week][]" id="dWeek5" class="dwList" value="5" checked><label for="dWeek5">金</label></span>
                <span><input type="checkbox" name="<?= $mainPrefix ?>[day_week][]" id="dWeek6" class="dwList" value="6" checked><label for="dWeek6">土</label></span>
                <span><input type="checkbox" name="<?= $mainPrefix ?>[day_week][]" id="dWeek7" class="dwList" value="0" checked><label for="dWeek7">日</label></span>
            </p>
            <p class="month_list">
                <?php if (isset($mainData['week_num'])) : ?>
                    <span>
                        <input type="checkbox" name="<?= $mainPrefix ?>[week_num][]" value="第1週" id="week1" <?= strpos($mainData['week_num'], '第1週') !== false ? 'checked' : '' ?>>
                        </label>第1週</label>
                    </span>
                    <span>
                        <input type="checkbox" name="<?= $mainPrefix ?>[week_num][]" value="第2週" id="week2" <?= strpos($mainData['week_num'], '第2週') != false ? 'checked' : '' ?>>
                        </label>第2週</label>
                    </span>
                    <span>
                        <input type="checkbox" name="<?= $mainPrefix ?>[week_num][]" value="第3週" id="week3" <?= strpos($mainData['week_num'], '第3週') != false ? 'checked' : '' ?>>
                        </label>第3週</label>
                    </span>
                    <span>
                        <input type="checkbox" name="<?= $mainPrefix ?>[week_num][]" value="第4週" id="week4" <?= strpos($mainData['week_num'], '第4週') != false ? 'checked' : '' ?>>
                        </label>第4週</label>
                    </span>
                    <span>
                        <input type="checkbox" name="<?= $mainPrefix ?>[week_num][]" value="第5週" id="week5" <?= strpos($mainData['week_num'], '第5週') != false ? 'checked' : '' ?>>
                        </label>第5週</label>
                    </span>
                    <span>
                        <input type="checkbox" name="<?= $mainPrefix ?>[week_num][]" value="第6週" id="week6" <?= strpos($mainData['week_num'], '第6週') != false ? 'checked' : '' ?>>
                        </label>第6週</label>
                    </span>
                <?php else : ?>
                    <span><input type="checkbox" name="<?= $mainPrefix ?>[week_num][]" value="第1週" id="week1"><label>第1週</label></span>
                    <span><input type="checkbox" name="<?= $mainPrefix ?>[week_num][]" value="第2週" id="week2"><label>第2週</label></span>
                    <span><input type="checkbox" name="<?= $mainPrefix ?>[week_num][]" value="第3週" id="week3"><label>第3週</label></span>
                    <span><input type="checkbox" name="<?= $mainPrefix ?>[week_num][]" value="第4週" id="week4"><label>第4週</label></span>
                    <span><input type="checkbox" name="<?= $mainPrefix ?>[week_num][]" value="第5週" id="week5"><label>第5週</label></span>
                    <span><input type="checkbox" name="<?= $mainPrefix ?>[week_num][]" value="第6週" id="week6"><label>第6週</label></span>
                <?php endif; ?>
            </p>
        </div>
        <div class="box1">
        ...
        <div class="box1">
            ...
            <select id="selServiceName" class="staff" name="<?= $mainPrefix ?>[service_name]" style="width:320px">
                <option value="">選択してください</option>
                <?php foreach ($svcMstType as $type) : ?>
            ...
            <ol id="dtl_root">
                <?php if (empty($serviceData)) : ?>
                    ...
                    <input type="hidden" name="<?= $svcPrefix ?>[user_id][]" value="<?= $userInfo['unique_id'] ?>">
                        <select class="validate[required]" id="start_time_h_<?= $detail_i ?>" name="<?= $svcPrefix ?>[start_time_h][]" style="width:60px;">
                            <?php foreach ($selHour as $val) : ?>
                                <option value="<?= $val ?>"><?= $val ?></option>
                            <?php endforeach; ?>
                        </select>
                        <small>：</small>
                        <select class="validate[required]" id="start_time_m_<?= $detail_i ?>" name="<?= $svcPrefix ?>[start_time_m][]" style="width:60px;">
                            <?php foreach ($selMinutes as $val) : ?>
                                <option value="<?= $val ?>"><?= $val ?></option>
                            <?php endforeach; ?>
                        </select>
                        <small>～</small>
                        <select class="validate[required]" id="end_time_h_<?= $detail_i ?>" name="<?= $svcPrefix ?>[end_time_h][]" style="width:60px;">
                            <?php foreach ($selHour as $val) : ?>
                                <option value="<?= $val ?>"><?= $val ?></option>
                            <?php endforeach; ?>
                        </select>
                        <small>：</small>
                        <select class="validate[required, custom[notEqualTime]]" id="end_time_m_<?= $detail_i ?>" data-index="<?= $detail_i ?>" name="<?= $svcPrefix ?>[end_time_m][]" style="width:60px;">
                            <?php foreach ($selMinutes as $val) : ?>
                                <option value="<?= $val ?>"><?= $val ?></option>
                            <?php endforeach; ?>
                        </select>
                        <select class="cngOffice validate[required]" name="<?= $svcPrefix ?>[service_detail_id][]" style="width:200px;">
                            <option value="">選択してください</option>
    ...
    <div class="s_constrols">
        ...
        <p>
            ...
            <button type="submit" name="btnDupliUser" value="true" class="btn save" style="width:60px;height:37px;font-size: 15px;">保存</button>
        </p>
    </div>
    <!-- 下部ボタンエリア:end-->
    <div class="update">
...
<?php endforeach; ?>
            ...
            $(".btn_append_jippi").click(function () {
                ...
                newRow += '    <select id="selJippiType' + jippi_i + '" data-index="' + jippi_i + '" name="<?= $jpiPrefix ?>[type][]" class="uis_type selJippiType cngJippi">';
                newRow += '        <option value="">選択してください</option>';
<?php foreach ($unInsType['type'] as $type => $dummy) : ?>
...
<?php endforeach; ?>
                ...
                newRow += '    <select id="jippiFieldName' + jippi_i + '" class="cngOffice uis_name cngJippi" name="<?= $jpiPrefix ?>[uninsure_id][]">';
                newRow += '        <option value="">選択してください</option>';
<?php foreach ($uisList as $type => $uisList2) : ?>
    <?php foreach ($uisList2 as $uisId => $uisData) : ?>
...
<?php endforeach; ?>
                ...
                newRow += '    <input id="jippiPrice' + jippi_i + '" type="text" class="validate[maxSize[7],onlyNumberSp] uis_price" name="<?= $jpiPrefix ?>[price][]" value="" style="width:85px">';
                newRow += '    </td>';
                newRow += '    <td class="tax">';
                newRow += '      <b class="sm">消費税<br>区分</b>';
                newRow += '      <select id="jippiZeiType' + jippi_i + '" name="<?= $jpiPrefix ?>[zei_type][]" class="uis_zei_type">';
<?php foreach ($unInsType['zei_type'] as $zeiType => $dummy) : ?>
...
<?php endforeach; ?>
                ...
                newRow += '      <input id="jippiUisRate' + jippi_i + '" type="text" class="validate[maxSize[7],onlyNumberSp] uis_rate" name="<?= $jpiPrefix ?>[rate][]" value="" style="width:60px;" placeholder="半角数字2桁"><span>%</span>';
                newRow += '    </td>';
                newRow += '    <td class="d_cate">';
                newRow += '      <b class="sm">控除区分</b>';
                newRow += '      <select id="jippiSubsidy' + jippi_i + '" name="<?= $jpiPrefix ?>[subsidy][]" class="uis_subsidy">';
<?php foreach ($unInsType['subsidy'] as $subsidy => $dummy) : ?>
...
<?php endforeach; ?>
            ...
            $(".btn_append_service").click(function () {
                ...
                newRow += '  <select class="validate[required]" id="start_time_h_' + index + '" name="<?= $svcPrefix ?>[start_time_h][]" style="width:60px;">';
                <?php foreach ($selHour as $val) : ?>
                newRow += '      <option value="<?= $val ?>"><?= $val ?></option>';
                <?php endforeach; ?>
                newRow += '  </select>';
                newRow += '  <small>：</small>';
                newRow += '  <select class="validate[required]" id="start_time_m_' + index + '" name="<?= $svcPrefix ?>[start_time_m][]" style="width:60px;">';
                <?php foreach ($selMinutes as $val) : ?>
                newRow += '      <option value="<?= $val ?>"><?= $val ?></option>';
                <?php endforeach; ?>
                newRow += '  </select>';
                newRow += '  <small>～</small>';
                newRow += '  <select class="validate[required]" id="end_time_h_' + index + '" name="<?= $svcPrefix ?>[end_time_h][]" style="width:60px;">';
                <?php foreach ($selHour as $val) : ?>
                newRow += '      <option value="<?= $val ?>"><?= $val ?></option>';
                <?php endforeach; ?>
                newRow += '  </select>';
                newRow += '  <small>：</small>';
                newRow += '  <select class="validate[required, custom[notEqualTime]]" id="end_time_m_' + index + '" data-index="' + index + '" name="<?= $svcPrefix ?>[end_time_m][]" style="width:60px;">';
                <?php foreach ($selMinutes as $val) : ?>
                newRow += '      <option value="<?= $val ?>"><?= $val ?></option>';
                <?php endforeach; ?>
                newRow += '  </select>';
                newRow += '  <select class="cngOffice validate[required]" name="<?= $svcPrefix ?>[service_detail_id][]" style="width:200px;">';
                newRow += '     <option value="">選択してください</option>';
<?php foreach ($svcDtlMst as $type => $svcDtlMst2) : ?>
    <?php foreach ($svcDtlMst2 as $tgtId => $val) : ?>
...
<?php endforeach; ?>
    ...
    <script>
        $(document).ready(function() {
            $("#dWeekAll").change(function() {
                $(".dwList").prop("checked", $(this).prop("checked"));
            });

            $(".dwList").change(function() {
                if (!$(this).prop("checked")) {
                    $("#dWeekAll").prop("checked", false);
                }
            });
        });
    </script>
